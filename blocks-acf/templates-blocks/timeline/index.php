<?php
/**
 * Time Line ACF Custom Block Render
 *
 * @package WordPress
	...
	<section id="<?php	echo esc_attr( $anchor ); ?>" class="">
		<div class="max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 lg:py-16 lg:grid-cols-12">
			...
			<div class="p-5">
				...
				<?php 
				while ( have_rows( 'time_line_list' ) ) :

					the_row();
					// Load values and assign defaults.
					$title       = get_sub_field( 'title' ) ? get_sub_field( 'title' ) : 'Your title here...';
					$description = get_sub_field( 'description' ) ? get_sub_field( 'description' ) : 'description here...';
