...
?>
	...
	<footer class="p-4 bg-slate-200 sm:px-6 md:py-12 dark:bg-gray-800">
		<div class="mx-auto max-w-screen-xl">
          ...
          wp_get_attachment_url(get_theme_mod('custom_logo'))
					...
					<!-- Second Column -->
					<div class="grid grid-cols-2 gap-8 lg:w-2/3 lg:gap-5 lg:grid-cols-3">
						<?php get_template_part('template-parts/footer/footer-c2-widgets'); ?>

						<?php get_template_part('template-parts/footer/footer-c3-widgets'); ?>

						<?php get_template_part('template-parts/footer/footer-c4-widgets'); ?>
					</div>
			</div>
			...
			<div class="sm:flex sm:items-center sm:justify-between">
				...
				<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 
					<a href="<?php echo get_site_url(); ?>" class="hover:underline">
